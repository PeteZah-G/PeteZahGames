...
(f) attack, scan, probe, overload, disrupt, or attempt unauthorized access to the Service, our infrastructure, other users, or third-party systems;
(g) bypass, disable, or interfere with security, CAPTCHA/proof-of-work, rate limits, bans, verification gates, or anti-abuse controls;
(h) use bots, scrapers, or automation except where we expressly allow it;
...
7.1 The Service may display advertisements from third-party networks and partners, including without limitation Adsterra, ExoClick, and other networks or direct sponsors we choose from time to time ("Ad Partners").
...
7.4 We may enable, disable, throttle, or replace Ad Partners (including setting flags such as EXOCLICK_ENABLED) at any time. Absence of one network does not mean the Service is ad-free.
...
8. Logging, Security, and Anti-Abuse (Summary)

We collect and process certain technical and account data as described in the Privacy Policy, including for security and anti-abuse. You consent to reasonable logging and automated enforcement needed to keep the Service usable.


9. Intellectual Property; License to You; Feedback

9.1 The Service's original branding, UI, code we own, and documentation are protected by IP laws. We grant you a limited, revocable, non-exclusive, non-transferable license to use the Service for personal, lawful purposes consistent with these Terms.

9.2 You may not copy, reverse engineer (except to the limited extent allowed by law), or create competing services by scraping our non-public interfaces.
...
If you post comments, feedback, profiles, avatars, or other content ("User Content"), you grant us a worldwide, royalty-free license to host, display, moderate, and remove it in connection with the Service. You represent you have rights to that content. We may remove User Content without notice.
...
You will defend, indemnify, and hold harmless us and our operators from and against any claims, damages, losses, costs, and expenses (including reasonable attorneys' fees) arising out of or related to: (a) your use or misuse of the Service; (b) your User Content; (c) your violation of these Terms or law; (d) your violation of school/employer/network policies; (e) your infringement of third-party rights; or (f) disputes between you and third parties accessed via the Service.
...
This Policy covers data processed when you visit our sites, pass verification, create an account, use proxy/relay features, claim links, play catalog games/apps, view ads, or interact with community features. It does not control third-party websites you visit through the proxy — those sites have their own policies.


2. Categories of Information We Collect

2.1 Account and profile data (if you register): email address; password (stored as a one-way hash, e.g. bcrypt — we do not store plaintext passwords); optional username, bio, avatar/banner, school, age, or similar profile fields you choose to provide; email verification status; optional two-factor authentication secrets/metadata for features that require them (e.g. Get Links); role flags (e.g. admin) for authorized operators.
...
2.5 Advertising technology: Ad Partners (such as Adsterra, ExoClick, Google advertising tags, and others) may set cookies, use pixels, or collect device/IP/user-agent data under THEIR policies to serve and measure ads. Their processing is governed primarily by those partners. See Section 7 of the Terms regarding aggressive or malicious ad creatives.

2.6 Analytics: we may use first-party or third-party analytics (including tag managers / measurement IDs present on some pages) to understand aggregate traffic and reliability.

2.7 Communications: emails you send us; verification or transactional emails we send you.
...
We try to keep friction low for legitimate users. At the same time we operate meaningful anti-abuse controls, which may include verification gates, signed cookies, rate limits, IP reputation, challenge/response, session binding, automated blocks, manual staff review, and cooperation with infrastructure providers. Those controls may process the security data listed above. Circumventing them is prohibited.


5. Legal Bases (Where Applicable)

Where GDPR/UK GDPR or similar frameworks apply, we rely on one or more of: performance of a contract (providing the Service you request); legitimate interests (security, anti-abuse, service improvement, limited analytics); consent (where we ask for it, including legal-document acceptance and certain optional features); and legal obligation.
...
We use hashing for passwords, HTTPS where configured, httpOnly cookies for sensitive tokens, rate limiting, and related controls. No method of transmission or storage is perfectly secure. You are responsible for device security and for not interacting with malicious advertisements.


10. International Transfers

Servers and vendors may be located in multiple countries. By using the Service you understand information may be processed outside your home country, with safeguards where required by law.


11. Your Choices and Rights

Depending on your location, you may have rights to access, correct, delete, export, or restrict certain personal data, or to object to certain processing. Contact ${LEGAL_CONTACT_EMAIL}. We may verify your identity before fulfilling requests. You may close your account where the product supports it. You may withdraw consent for optional features; essential processing for security may continue if you keep using the Service.

California / similar U.S. state laws: we do not knowingly "sell" or "share" personal information for cross-context behavioral advertising as a primary business model, but Ad Partners may engage in advertising measurement. Use platform/ad settings and browser controls where available. You may designate an authorized agent as permitted by law.
...
There is no uniform DNT standard we can promise to honor across Ad Partners. Our own essential security tooling will continue to function.
